  ...
  return (
    <footer className="bg-lightSecondary mt-24 lg:p-14 p-10 flex items-center justify-center flex-col lg:w-3/4 w-[92%] relative left-1/2 -translate-x-1/2 rounded-t-[25px] text-[#0D0D0D] space-y-10">
      <h2 className="lg:text-3xl text-2xl font-poppinsSemiBold relative text-center leading-10">
        <Image src={zigzag} alt="zigzag" className="absolute top-8 left-28 lg:w-32 w-24" />
        <Image
          src={loop}
          alt="loop"
      ...
      <div className="bg-white lg:px-5 px-3 lg:py-3 py-1 xl:w-2/3 sm:w-3/4 w-full text-base rounded-full flex items-center space-x-3">
        <Image src={magnifyingGlass} alt="maginifying glass" className="lg:h-7 h-5" />
        <input
      ...
      <div className="flex space-x-12">
        <span className="cursor-pointer" onClick={() => handleLinkClick('https://www.facebook.com/Feedough/')}>
          <Image src={Facebook} alt="Facebook" />
        </span>
        <span className="cursor-pointer" onClick={() => handleLinkClick('https://twitter.com/feedoughcom')}>
          <Image src={Twitter} alt="Twitter" />
        </span>
        <span className="cursor-pointer" onClick={() => handleLinkClick('https://www.instagram.com/feedoughcom')}>
          <Image src={Instagram} alt="Instagram" />
        </span>
        <span className="cursor-pointer" onClick={() => handleLinkClick('https://in.linkedin.com/company/feedough')}>
      ...
      <div className="w-full flex justify-between lg:flex-row flex-col items-center lg:space-y-0 space-y-10">
        <span className="font-poppinsLight opacity-60 text-xs">Copyright © 2023 Feedough</span>
        <Link
          prefetch={false}
