...
const termsAndConditions = () => {
  return (
    <div className="bg-options h-full min-h-screen px-[12.5%] leading-7">
      <Navbar />
      <WebPageJsonLd description="Terms and Conditions page for namegen" id="https://namegen.io/terms-and-conditions" />
      <div className="py-36 text-lg">
        <h1 className="text-3xl">
          <strong>Terms and Conditions</strong>
        </h1>
        <br />
        <p>Welcome to Namegen!</p>
        <br />
        <p>
          These terms and conditions outline the rules and regulations for the use of Feedough&apos;s Website, located
          at namegen.io.
        </p>
        <br />
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Namegen if
        ...
        <p>
          ...
          prevailing law of in. Any use of the above terminology or other words in the singular, plural, capitalization
        ...
        <p>
          We employ the use of cookies. By accessing Namegen, you agreed to use cookies in agreement with the
          Feedough&apos;s Privacy Policy.{' '}
        </p>
        <br />
        <p>
        ...
        <p>
          Unless otherwise stated, Feedough and/or its licensors own the intellectual property rights for all material
          on Namegen. All intellectual property rights are reserved. You may access this from Namegen for your own
        ...
        <br />
        <ul>
          <li>Republish material from Namegen</li>
          <li>Sell, rent or sub-license material from Namegen</li>
          <li>Reproduce, duplicate or copy material from Namegen</li>
          <li>Redistribute content from Namegen</li>
          <br />
        </ul>
        <p>
          Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. Feedough does not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of Feedough,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Feedough shall not be liable for the Comments or for any liability, damages or expenses
          caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
          website.
        </p>
        <br />
        <p>
          Feedough reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Feedough a non-exclusive license to use, reproduce, edit and authorize others to use,
          reproduce and edit any of your Comments in any and all forms, formats or media.
        </p>
        <br />
        <h3 className="text-2xl">Hyperlinking to our Content</h3>
        ...
        <p>
          ...
          Feedough; and (d) the link is in the context of general resource information.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Feedough. Please include your name, your organization name, contact
        ...
        <p>
          No use of Feedough&apos;s logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>
        <br />
        <h3 className="text-2xl">iFrames</h3>
        <p>
        ...
        <br />
        <h3 className="text-2xl">Content Liability</h3>
        <p>
        ...
        <br />
        <h3 className="text-2xl">Reservation of Rights</h3>
        <p>
        ...
        <br />
        <h3 className="text-2xl">Removal of links from our website</h3>
        <p>
