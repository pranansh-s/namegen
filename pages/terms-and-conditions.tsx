...
const termsAndConditions = () => {
	return (
		<div className="bg-options h-full min-h-screen px-[12.5%] leading-7">
			<Navbar />
			<WebPageJsonLd
				description="Terms and Conditions page for namegen"
				id="https://namegen.io/terms-and-conditions"
			/>
			<div className="py-36 text-lg">
				...
				<p>
					...
					use of Feedough&apos;s Website, located at namegen.io.
				</p>
				<br />
				<p>
					By accessing this website we assume you accept these terms and
					conditions. Do not continue to use Namegen if you do not agree to take
				...
				<p>
					We employ the use of cookies. By accessing Namegen, you agreed to use
					cookies in agreement with the Feedough&apos;s Privacy Policy.{' '}
				</p>
				<br />
				<p>
				...
				<p>
					Unless otherwise stated, Feedough and/or its licensors own the
					intellectual property rights for all material on Namegen. All
					intellectual property rights are reserved. You may access this from
					Namegen for your own personal use subjected to restrictions set in
				...
				<p>
					...
					Feedough does not filter, edit, publish or review Comments prior to
					their presence on the website. Comments do not reflect the views and
					opinions of Feedough,its agents and/or affiliates. Comments reflect
					the views and opinions of the person who post their views and
					opinions. To the extent permitted by applicable laws, Feedough shall
				...
				<br />
				<p>
					Feedough reserves the right to monitor all Comments and to remove any
				...
				<p>
					You hereby grant Feedough a non-exclusive license to use, reproduce,
				...
				<p>
					...
					the hyperlink compensates the absence of Feedough; and (d) the link is
				...
				<p>
					...
					sending an e-mail to Feedough. Please include your name, your
				...
				<p>
					No use of Feedough&apos;s logo or other artwork will be allowed for
