...
const privacyPolicy = () => {
  return (
    <div className="bg-options h-full min-h-screen px-[12.5%] leading-7">
      <WebPageJsonLd description="Privacy Policy page for namegen" id="https://namegen.io/privacy-policy" />
      <Navbar />
      <div className="py-36 text-lg">
        <h1 className="text-3xl font-poppinsSemiBold">Privacy Policy for Feedough</h1>
        <br />
        At Namegen, accessible from namegen.io, one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and recorded by Namegen and how we use it.
        <br />
        <br />
        ...
        to the information that they shared and/or collect in Namegen. This policy is not applicable to any information
        collected offline or via channels other than this website.
        <br />
        <br />
        <h3 className="text-2xl">Consent</h3>
        ...
        <br />
        <br />
        <h3 className="text-2xl">Log Files</h3>
        Namegen follows a standard procedure of using log files. These files log visitors when they visit websites. All
        ...
        <br />
        <br />
        <h3 className="text-2xl">Advertising Partners Privacy Policies</h3>
        You may consult this list to find the Privacy Policy for each of the advertising partners of Namegen.
        <br />
        <br />
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Namegen, which are sent directly to users&apos;
        ...
        <br />
        <br />
        Note that Namegen has no access to or control over these cookies that are used by third-party advertisers.
        <br />
        <br />
        <h3 className="text-2xl">Third Party Privacy Policies</h3>
        Namegen&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <br />
        <br />
        <h3 className="text-2xl">CCPA Privacy Rights (Do Not Sell My Personal Information)</h3>
        ...
        <br />
        <br />
        <h3 className="text-2xl">GDPR Data Protection Rights</h3>
        ...
        <br />
        <br />
        <h3 className="text-2xl">Children&apos;s Information</h3>
        ...
        <br />
        <br />
        Namegen does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
