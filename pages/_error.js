  ...
  return (
    <div>
      ...
      <div className="bg-options h-full min-h-screen items-center flex flex-col space-y-10 justify-center px-10 text-center">
        <h1 className="font-poppinsSemiBold lg:text-3xl text-2xl tracking-widest text-secondary">Page Not Found</h1>
        <Image src={NotFound} alt="404 Not Found" className="lg:w-[35rem] w-[25rem]" />
